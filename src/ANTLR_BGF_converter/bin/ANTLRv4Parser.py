...
class ANTLRv4Parser(Parser):
    ...
    def grammarSpec(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & (
                    (1 << ANTLRv4Parser.OPTIONS) | (1 << ANTLRv4Parser.TOKENS) | (1 << ANTLRv4Parser.CHANNELS) | (
                    1 << ANTLRv4Parser.IMPORT) | (1 << ANTLRv4Parser.AT))) != 0):
                self.state = 135
    ...
    def modeSpec(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & (
                    (1 << ANTLRv4Parser.TOKEN_REF) | (1 << ANTLRv4Parser.DOC_COMMENT) | (
                    1 << ANTLRv4Parser.FRAGMENT))) != 0):
                self.state = 275
                self.lexerRuleSpec()
                self.state = 280
                self._errHandler.sync(self)
    ...
    def rules(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & (
                    (1 << ANTLRv4Parser.TOKEN_REF) | (1 << ANTLRv4Parser.RULE_REF) | (
                    1 << ANTLRv4Parser.DOC_COMMENT) | (1 << ANTLRv4Parser.FRAGMENT) | (1 << ANTLRv4Parser.PROTECTED) | (
                            1 << ANTLRv4Parser.PUBLIC) | (1 << ANTLRv4Parser.PRIVATE))) != 0):
                self.state = 281
                self.ruleSpec()
                self.state = 286
                self._errHandler.sync(self)
    ...
    def parserRuleSpec(self):
        ...
        try:
            ...
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & (
                    (1 << ANTLRv4Parser.FRAGMENT) | (1 << ANTLRv4Parser.PROTECTED) | (1 << ANTLRv4Parser.PUBLIC) | (
                    1 << ANTLRv4Parser.PRIVATE))) != 0):
                self.state = 297
                self.ruleModifiers()
    ...
    def lexerAlt(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [ANTLRv4Parser.TOKEN_REF, ANTLRv4Parser.RULE_REF, ANTLRv4Parser.LEXER_CHAR_SET,
                         ANTLRv4Parser.STRING_LITERAL, ANTLRv4Parser.BEGIN_ACTION, ANTLRv4Parser.LPAREN,
                         ANTLRv4Parser.DOT, ANTLRv4Parser.NOT]:
                self.enterOuterAlt(localctx, 1)
                self.state = 409
                self.lexerElements()
                self.state = 411
    ...
    def lexerElements(self):
        ...
        try:
            ...
            while True:
                ...
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & (
                        (1 << ANTLRv4Parser.TOKEN_REF) | (1 << ANTLRv4Parser.RULE_REF) | (
                        1 << ANTLRv4Parser.LEXER_CHAR_SET) | (1 << ANTLRv4Parser.STRING_LITERAL) | (
                                1 << ANTLRv4Parser.BEGIN_ACTION) | (1 << ANTLRv4Parser.LPAREN) | (
                                1 << ANTLRv4Parser.DOT) | (1 << ANTLRv4Parser.NOT))) != 0)):
                    break
    ...
    def lexerElement(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & (
                        (1 << ANTLRv4Parser.QUESTION) | (1 << ANTLRv4Parser.STAR) | (1 << ANTLRv4Parser.PLUS))) != 0):
                    self.state = 422
                    self.ebnfSuffix()
    ...
    def labeledLexerElement(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [ANTLRv4Parser.TOKEN_REF, ANTLRv4Parser.LEXER_CHAR_SET, ANTLRv4Parser.STRING_LITERAL,
                         ANTLRv4Parser.DOT, ANTLRv4Parser.NOT]:
                self.state = 441
                self.lexerAtom()
                pass
    ...
    def alternative(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [ANTLRv4Parser.TOKEN_REF, ANTLRv4Parser.RULE_REF, ANTLRv4Parser.STRING_LITERAL,
                         ANTLRv4Parser.BEGIN_ACTION, ANTLRv4Parser.LPAREN, ANTLRv4Parser.LT, ANTLRv4Parser.DOT,
                         ANTLRv4Parser.NOT]:
                self.enterOuterAlt(localctx, 1)
                self.state = 483
                self._errHandler.sync(self)
                ...
                while True:
                    ...
                    if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & (
                            ...
                            1 << ANTLRv4Parser.STRING_LITERAL) | (1 << ANTLRv4Parser.BEGIN_ACTION) | (
                                    1 << ANTLRv4Parser.LPAREN) | (1 << ANTLRv4Parser.DOT) | (
                                    1 << ANTLRv4Parser.NOT))) != 0)):
                        break
        ...
        try:
            ...
            if la_ == 1:
                ...
                if token in [ANTLRv4Parser.QUESTION, ANTLRv4Parser.STAR, ANTLRv4Parser.PLUS]:
                    ...
                    self.ebnfSuffix()
                    pass
                elif token in [ANTLRv4Parser.TOKEN_REF, ANTLRv4Parser.RULE_REF, ANTLRv4Parser.STRING_LITERAL,
                               ANTLRv4Parser.BEGIN_ACTION, ANTLRv4Parser.SEMI, ANTLRv4Parser.LPAREN,
                               ANTLRv4Parser.RPAREN, ANTLRv4Parser.OR, ANTLRv4Parser.DOT, ANTLRv4Parser.POUND,
                               ANTLRv4Parser.NOT]:
                    pass
                else:
                    raise NoViableAltException(self)
    ...
    def block(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & (
                    (1 << ANTLRv4Parser.OPTIONS) | (1 << ANTLRv4Parser.COLON) | (1 << ANTLRv4Parser.AT))) != 0):
                self.state = 586
                self._errHandler.sync(self)
                _la = self._input.LA(1)
